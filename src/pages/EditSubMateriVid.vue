<template>
  <q-page>
            ...
            >
              <div class="row">
                <div class="col-6" style="display: block">
                  ...
                  <div v-if="video64" class="row q-py-md">
                    <div class="col-12 self-center" style="display: block">
                      <video
                        controls
                        :src="video64"
                ...
                <div class="col-6 self-center justify-center row">
                  ...
                  >
                    <q-img src="~/assets/gng.svg" width="25%" />
                    <div class="text-weight-medium">tambah video</div>
                  </q-btn>
                </div>
              </div>
            </q-card>
    ...
    <q-file
      ...
      @update:model-value="previewVideo"
      v-show="false"
      accept="video/*"
    ></q-file>
...
export default {
  ...
  methods: {
    init() {
      ...
      if (this.moduleContentById.video) {
        // this.videoId = this.moduleContentById.video.id;
        this.video64 =
          this.STORAGE_URL + "/" + this.moduleContentById.video.src;
      }
    ...
    async previewVideo(file) {
      let res = await fileToBase64(file);
      this.video64 = res.src;
      ...
      return new Promise((resolve, reject) => {
        this.$store
          ...
          .then((res) => {
            ...
            // console.log("cek res by id", res.data);
            resolve(res);
          })
          .catch((err) => {
            reject(err);
